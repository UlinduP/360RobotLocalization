...
time_split_1 = 1708418913.169285    # 2024-02-06-21-40-49 time_split_1 = 1707227007.194655 , time_split_2 = 1707227126.116658  ,,    2024-02-06-21-34-18    time_split_1 = 1707226624.239907, time_split_2 = 1707226750.236465_B  ,, 
...
data_dir = f'insta360/2024-02-20-16-44-28_images/*.jpg'        #insta360\validation_2024-02-06-21-40-49_images       insta360/2024-02-20-16-34-57_images

column_names = ['timestamp', 'x', 'y','heading']
gt_df = pd.read_csv('insta360/2024-02-20-16-44-28_gt.txt',sep=',',names=column_names)

trained_model = distance_estimation.Distance()
trained_model.load_state_dict(torch.load("./models/model_1-8-16-32-64-32-16-8-1_2048X2048imgs_first_floor.pth"))     #\model_1-8-16-32-64-32-16-8-1_2048X2048imgs_first_floor.pth
...
data_df_with_gt = utils.combine_df(data_df, gt_df, time_split_1 = time_split_1, time_split_2 = time_split_2)        ##### Night HR Testing datset ( 1707227007.194655  1707227126.116658  )      
#### first floor ( time_split_1 = 1708418913.169285, time_split_2 = 1708419046.290048 )

# change the order of columns
data_df_with_gt = data_df_with_gt[['filename','inference_time', 'robot_in_the_frame_or_not','detected_or_not',"parallel_pixel_dist", "size","perp_dist_to_the_robot_pred",'dist_to_the_robot_gt','parallel_dist_to_the_robot_gt','perp_dist_to_the_robot_gt','angle']]

plot.plot_image_number_vs_dist(data_df_with_gt)

data_df_with_gt.to_csv("./csv_data/2024-02-20-16-44-28_first_floor_output_dataframe.csv", index=False)
